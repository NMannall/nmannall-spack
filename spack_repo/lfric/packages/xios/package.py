...
class Xios(Package):
    ...
    version(
        "3.0.4.0",
        tag="xios-3.0.4.0",
        commit="8773b0e4278f570fd3ec714e7ab14d9b0b6e81ca"
    )
    version(
        "3.0.3.1",
        tag="xios-3.0.3.1",
        commit="b0c74eafb86defe05e283aed91eb022712c13355"
    )
    version(
        "3.0.3.0",
        tag="xios-3.0.3.0",
        commit="cad41d48bc1b0f036acbce2039413f1615bf714e"
    )
    version(
        "3.0.2.2",
        tag="xios-3.0.2.2",
        commit="1eaf434c3386e50b03d12d32932c423bf66463b6"
    )
    version(
        "3.0.2.1",
        tag="xios-3.0.2.1",
        commit="534c7d08153aa81b0a29d4f49e272e7d3ade4aed"
    )
    version(
        "3.0.2.0",
        tag="xios-3.0.2.0",
        commit="167e30c2edbf7ee4beb9e4f7c27861267110c943"
    )
    version(
        "3.0.1.0",
        tag="xios-3.0.1.0",
        commit="6b770a30b69c469d1c86385dc561e72a72dd8032"
    )
    version(
        "2.6.1.0",
        tag="xios-2.6.1.0",
        commit="91553d0fe09e6dd502cec96bf44f7c37b316a110"
    )
    ...
    variant("oasis", default=False, description="Support for OASIS coupler")
